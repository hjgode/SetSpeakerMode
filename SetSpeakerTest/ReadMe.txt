================================================================================
    MICROSOFT FOUNDATION CLASS LIBRARY : SetSpeakerTest Project Overview
===============================================================================

The application wizard has created this SetSpeakerTest application for 
you.  This application not only demonstrates the basics of using the Microsoft 
Foundation Classes but is also a starting point for writing your application.

This file contains a summary of what you will find in each of the files that
make up your SetSpeakerTest application.

SetSpeakerTest.vcproj
...
SetSpeakerTest.h
    ...
    project specific headers and declares the CSetSpeakerTestApp application class.

SetSpeakerTest.cpp
    This is the main application source file that contains the application
    class CSetSpeakerTestApp.


SetSpeakerTestppc.rc
...
res\SetSpeakerTestppc.rc2
    This file contains resources that are not edited by Microsoft 
    Visual C++. You should place all resources not editable by
    the resource editor in this file.


res\SetSpeakerTest.ico
...
SetSpeakerTestDlg.h, SetSpeakerTestDlg.cpp - the dialog
    These files contain your CSetSpeakerTestDlg class.  This class defines
...
StdAfx.h, StdAfx.cpp
    ...
    named SetSpeakerTest.pch and a precompiled types file named StdAfx.obj.
